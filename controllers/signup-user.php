<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $checkUsernameQuery = "SELECT * FROM gmb_dashboard_users WHERE username = '$username'";
        ...
        if ($checkUsernameRow['username'] == $username) {
            ...
            $insertUserQuery = "INSERT INTO gmb_dashboard_users(username,user_password) VALUES('$username', '$hashedPassword')";
