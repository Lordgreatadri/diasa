<?php
    ...
    {
    	$ussd_user = trim($_GET['view_ussd_action']);	
    }
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h5 class="text-center">USSD details for <b> <?php echo $ussd_user; ?></b></h5>
                                    <?php 
                                          //session_start();
                                ...
                                <table id="bootstrap-data-table" class="table  table-bordered table-hover">
                                    ...
                                    <tbody>
                                         ...
                                         <?php
                                            ...
                                            $stmnt = "SELECT * FROM diasa_pay WHERE contestant_name = '$ussd_user' AND device = 'ussd' ORDER BY `when` DESC LIMIT 0,1000";
