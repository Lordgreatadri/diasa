<?php
  ...
  include_once "db-config.php";
    ...
    $sql = "SELECT contestant_id AS CODE, name AS 'CONTESTANT NAME', status AS STATUS,  num_of_votes AS VOTES FROM contestants_weekly WHERE status = 'not_evicted' ORDER BY num_of_votes DESC";//s.date_unsub = '$today_date'
