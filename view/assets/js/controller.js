...
function getDashboardSummary() {
    $.get(CONSTANTS.GET_DASHBOARD_SUMMARY_URL, function(response) {
        ...
        $('.number-of-visa-votes-res').html(response.data.numberOfVisaVotes);
        $('.number-of-app-votes-res').html(response.data.numberOfAPPVotes);
        $('.number-of-ussd-votes-res').html(response.data.numberOfUSSDVotes);
        $('.number-of-web-votes-res').html(response.data.numberOfWEBVotes);
