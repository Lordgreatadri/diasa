        ...
        <div class="container-fluid main-div">
            <div class="row">
                ...
                <div class="col-md-10 content-div">
                    <h5 class="text-center">Recent Crawlers</h5>
                    <p class="text-center">Download all cawlers or Filter and download by date range <br><small> Overall crawlers</small></p>
                    <h6 class="text-center text-danger">Please use Mozilla Firefox for good perfomance</h6>
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                ...
                                <div class="">
                                    <div class="form-group">
                                        <br>
                                        <button class="btn btn-md btn-warning" onclick="filterAndDownloadCrawler()">Filter</button>                           
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function filterAndDownloadCrawler() {
        var startDate = jQuery(".start-date").val().trim(),
            ...
            //filterKey = jQuery(".dataTables_filter input.form-control-sm").val().trim();
             window.location.href = "fetch-crawlers.php?startDate="+startDate+"&endDate="+endDate;
