                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h5 class="text-center">WEB details for <b> <?php echo $web_user; ?></b></h5>
                                    <?php 
                                          //session_start();
                                ...
                                <span style="float: right;">
                                    <button class="btn btn-secondary"> <a style="text-decoration: none; color: white;" href="controllers/export_contestantchannel.php?channel=<?php echo 'web'; ?>&nominee=<?php echo $web_user; ?>"><b>Export Data</b></a></button>
                                </span>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table  table-bordered table-hover">
                                    ...
                                    <tbody>
                                         ...
                                         <?php
                                            ...
                                            $stmnt = "SELECT * FROM diasa_pay WHERE contestant_name = '$web_user' AND device = 'web' ORDER BY `when` DESC LIMIT 0,1000";
