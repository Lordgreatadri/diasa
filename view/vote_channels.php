        ...
        <div class="container-fluid main-div">
            <div class="row">
                                ...
                                <table id="bootstrap-data-table" class="table  table-bordered table-hover">
                                    ...
                                    <tbody>
                                         ...
                                         <?php
                                            ...
                                            $stmnt = "SELECT * FROM contestants ORDER BY num_of_votes DESC";
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $rows['num_of_votes'];?></td>
                                        <td> 
                                            <!-- &nbsp; -->
                                            <a href="view_all_channel.php?all_channel_action=<?php echo $rows['name'];?>" id="vorter_details" onclick="return confirm('Do you want to view all records this nominee?');">
               ...
               <!-- trash-o -->         </td>
                                        ...
                                        <td>
                                           <!--  &nbsp; -->
                                            <a href="view_ussd.php?view_ussd_action=<?php echo $rows['name'];?>" id="vorter_details" onclick="return confirm('Do you want to view ussd record for this nominee?');">
                                        ...
                                        <td>
                                            <!-- &nbsp; -->
                                            <a href="view_web.php?web_action=<?php echo $rows['name'];?>" id="vorter_details" onclick="return confirm('Do you want to view web record for this nominee?');">
                                        ...
                                        <td>
                                            <!-- &nbsp; -->
                                            <a href="view_sms.php?sms_action=<?php echo $rows['name'];?>" id="vorter_details" onclick="return confirm('Do you want to view sms record for this nominee?');">
                                        ...
                                        <td>
                                            &nbsp;
                                            <a href="view_app.php?app_action=<?php echo $rows['name'];?>" id="vorter_details" onclick="return confirm('Do you want to view app record for this nominee?');">
