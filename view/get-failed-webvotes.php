...
$query = "SELECT `contestant_name`, `description`, `phone_number`, `channel_type`, `amount`, `date_stamp`  FROM temp_monitor_online_payment WHERE `res_code` != '0000' ORDER BY `date_stamp` DESC";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $filename = "failed_ONLINEvote_Data.csv";
